...
<body>
    ...
    <div class="hero d-flex w-100 h-100 mx-auto flex-column pb-5" <?php if (get_current_slug() == '') { ?> style="background-image:url('<?php echo get_custom_header()->url; ?>');background-repeat: no-repeat;background-position:top center;background-size:cover; background-attachment:fixed" <?php } else {
                                                                                                                                                                                                                                                                                                    echo '';
                                                                                                                                                                                                                                                                                                } ?>>
        <header class="">
        ...
        <div class="intro container">
            ...
            if ( is_active_sidebar( 'home-banner-boxes' ) ) 
                dynamic_sidebar( 'home-banner-boxes' ); 
