...
<body>
    ...
    <div class="hero d-flex w-100 h-100 mx-auto flex-column pb-5"  style="background-image:url('<?= esc_url(get_template_directory_uri() . '/assets/images/cover-002.webp') ?>');background-repeat: no-repeat;background-position:top center;background-size:cover; background-attachment:fixed">
        <header class="">
